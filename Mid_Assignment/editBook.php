...
<html>
	  ...
	  <title>Edit Book</title>
	     ...
	     <body>
		 <span><h1 align="center">Edit Book</h1></span>
					...
					<tr>
					   ...
					   <tr>
					          <td><span><b>Add Info:</b></span></td>
					           <td><textarea name="info"  value = "<?php echo $info;?>" placeholder="Info"><?php echo $info;?></textarea></td>
					           <td><span><?php echo $err_info;?></span></td>
				                 </tr>
					   <br>
				        
					    <tr  align = "middle">
				             <td colspan = "3"><input type="submit" name="submit "value="Edit Book"></td>
